...
export const teaLogs = pgTable("tea_logs", {
  ...
  timerSettings: jsonb("timer_settings"), // { temp: 85, duration: 60, type: 'gongfu' }
...
export const insertTeaLogSchema = createInsertSchema(teaLogs).omit({ id: true, lastBrewedAt: true });
