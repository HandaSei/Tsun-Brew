...
export default function TeaDetails() {
  ...
  return (
    <div className="min-h-screen bg-background pb-20 flex flex-col">
      ...
      <div className="glass-card relative overflow-hidden rounded-none" style={{ borderLeft: 'none', borderRight: 'none', borderTop: 'none' }}>
        ...
        <div className="container mx-auto px-4 py-6 md:py-8 relative">
          <div className="flex flex-col md:flex-row gap-6 items-start">
            <div className="w-56 md:w-64 aspect-square rounded-md bg-secondary/30 relative shrink-0 group mx-auto md:mx-0" style={{ perspective: '800px' }}>
